  ...
  return (
    <div className="relative flex items-center group">
      <button
        ...
        title={statusMessage || "Start Voice Input"}
      ...
      {/* Tooltip for status message to prevent overlapping with input text */}
      {statusMessage && (
        <div className="absolute right-0 top-full mt-2 w-max max-w-[200px] rounded bg-slate-800 px-3 py-2 text-xs text-white opacity-0 transition-opacity group-hover:opacity-100 pointer-events-none z-10 shadow-lg">
          {statusMessage}
        </div>
      )}
    </div>
